...
from models.losses import cross_entropy, softmax_cross_entropy
...
class CDTrainer():
    ...
    def __init__(self, args, dataloaders):
        ...
        elif args.loss == 'unsuper':
            self._pxl_loss = softmax_cross_entropy
        else:
    ...
    def _load_checkpoint(self, ckpt_name='last_ckpt.pt'):
        ...
        checkpoint = torch.load('ckpt_dir/0310_PVP/best_ckpt.pt', map_location=self.device)
        self.net_G.load_state_dict(checkpoint['model_G_state_dict'])
        params, param_names = collect_params(self.net_G)
        self.optimizer_G = optim.Adam(params, lr=1e-3,
                                          betas=(0.9, 0.999),
                                          weight_decay=0)
    ...
    def _backward_G(self):
        ...
        self.G_loss = self._pxl_loss(self.G_pred, self.G_pred)
