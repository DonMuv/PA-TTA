...
class BASE_Transformer(ResNet):
    ...
    def forward_decoder(self, x1, x2, is_seg=True):
        # if text2vis:
        #     x1 = self.forward_single(x1)
        #     x2 = self.forward_single(x2)
        #     return x1, x2
        ...
        if is_seg:
            seg1 = self.upsamplex4(x1)
            seg1 = self.classifier(seg1)
            seg2 = self.upsamplex4(x2)
            seg2 = self.classifier(seg2)
            return seg1, seg2, x1, x2, 
        else:
            return x1, x2
