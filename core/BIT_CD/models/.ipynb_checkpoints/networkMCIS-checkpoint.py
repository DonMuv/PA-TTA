...
class BASE_Transformer(ResNet):
    ...
    def forward(self, x1, x2, labelA, labelB):
        ...
        # new #############################
        outA = self.mcis.forward_mcis(Afeat, x1, labelA)
        outB = self.mcis.forward_mcis(Bfeat, x2, labelB)
...
class MCIS(nn.Module):
    ...
    def forward_mcis(self, feat, seg, label_cls):
