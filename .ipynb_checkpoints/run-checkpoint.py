...
def load_model_PV():
    ...
    model_path = 'core/BIT_CD/ckpt_dir/best_ckpt.pt'
    # ⚠️ The source model weight exceeds the size limit and can be downloaded through the link:
    # https://drive.google.com/file/d/1Kn7WYDL7lYalXuUpDwkI9vyoL5gHzo9m/view?usp=drive_link
